...
def berries():
    berries_list = [
        {"name": "Брусника", "image": url_for("static", filename="брусника.jpg"),
        ...
        {"name": "Малина", "image": url_for("static", filename="малина.jpg"), 
        ...
        {"name": "Арбуз","image": url_for("static", filename="арбуз.jpg"),
        ...
        {"name": "Голубика","image": url_for("static", filename="голубика.jpg"),
        ...
        {"name": "Гранат", "image": url_for("static", filename="гранат.jpg"),
        ...
        {"name": "Ежевика","image": url_for("static", filename="ежевика.jpg"),
